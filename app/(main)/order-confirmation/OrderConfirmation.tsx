...
import {
  CheckCircle2, Truck, Package, Phone, ChevronRight, Leaf, Printer,
} from "lucide-react";
  ...
  if (!order) {
    return (
      <div className="min-h-screen bg-[#faf7f2] flex flex-col items-center justify-center px-4 text-center py-20">
        ...
        <p className="text-[#7a7a68] mb-6">
          We could not find this order. It may have expired from your browser.
        </p>
        <Link href="/track-order" className="text-[#3d6b35] font-bold underline underline-offset-2">
          Track your order →
        </Link>
      </div>
    );
      ...
      <div className="bg-[#1e3d18] pt-12 pb-16 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-[#a0d878] text-base mb-4">
            Thank you, <strong>{order.address.name}</strong>! We are getting your plants ready.
          </p>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 -mt-6 pb-16">
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d0] p-5 mb-5 flex items-center gap-4 shadow-sm">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold text-[#7a9e6a] uppercase tracking-wide">
              Estimated Delivery
            </p>
        ...
        <div className="bg-[#eef5ea] border border-[#b8d4a0] rounded-2xl px-5 py-4 mb-5 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-[#1e3d18]">Check your email</p>
            <p className="text-xs text-[#5a7a50] mt-0.5">
              We have sent your order confirmation and invoice to your email address.
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d0] overflow-hidden mb-5">
          ...
          {order.items.map((item, i) => (
            <div key={i} className="flex items-center gap-3 px-5 py-3.5 border-b border-[#f0ece4] last:border-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                {item.variant && (
                  <p className="text-xs text-[#7a7a68]">{item.variant}</p>
                )}
          ...
          <div className="px-5 py-4 bg-[#faf7f2] flex flex-col gap-2">
            <div className="flex justify-between text-xs text-[#5a5a48]">
              <span>Subtotal</span>
              <span className="font-semibold">Rs.{order.subtotal.toLocaleString("en-IN")}</span>
            </div>
            ...
            <div className="flex justify-between items-baseline pt-2 border-t border-[#e8e0d0]">
              ...
              <span className="text-xl font-black text-[#3d6b35]">
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d0] p-5 mb-5">
          <h2 className="text-sm font-bold text-[#2a2a1e] mb-3 uppercase tracking-wide">
            Delivering to
          </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-5">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 bg-white border-2 border-[#d4c9a8] hover:border-[#3d6b35] text-[#3d6b35] font-bold py-4 px-5 rounded-xl transition-all"
        ...
        <div className="mt-2 text-center">
          ...
          <a
            ...
            className="text-sm font-bold text-[#3d6b35] flex items-center gap-1 justify-center"
          >
