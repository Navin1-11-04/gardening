...
const navItems = [
  { label: "Dashboard",  href: "/admin/dashboard",  icon: LayoutDashboard, description: "Overview & live stats" },
  ...
  { label: "Export",     href: "/admin/export",     icon: Download,        description: "Download CSV data" },
